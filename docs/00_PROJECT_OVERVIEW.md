...
| バージョン | `0.1.1` | `package.json` `version` |
...
| 最新リリース | [v0.1.1](https://github.com/satoshi-hashimoto52/KoeNote/releases/latest) | GitHub Releases |

配布物は `KoeNote-0.1.1-arm64.dmg` / `KoeNote-0.1.1-arm64.zip` / `SHA256SUMS.txt` の 3 点です。
